...
export const ShimmerButton = React.forwardRef((
  ...
  return (
    <button
      style={
        {
          ...
          "--cut": shimmerSize,
          "--bg": background,
          "--hvbg": hoverBackground,
        }
      }
      className={cn(
        "group relative z-0 flex cursor-pointer items-center justify-center overflow-hidden whitespace-nowrap border border-white/10 px-4 py-2 text-white [background:var(--bg)] [border-radius:var(--radius)] [hover:background:var(--hvbg)]",
      ...
      <div
        className={cn(
          "absolute -z-20 [background:var(--bg)] group-hover:[background:var(--hvbg)] [border-radius:var(--radius)] [inset:var(--cut)]"
        )} />
    </button>
  );
});
