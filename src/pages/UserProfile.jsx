...
const UserProfile = () => {
  ...
  return (
    <div className="p-8 max-w-md mx-auto bg-slate-900 border border-slate-700 rounded-lg shadow-md mt-10">
      ...
      <form onSubmit={handleSave} className="space-y-6">
        <div>
          ...
          <input
            ...
            className="mt-1 block w-full rounded-md border-slate-600 shadow-sm sm:text-sm bg-slate-800 text-slate-400 cursor-not-allowed"
            disabled
          />
        </div>
        <div>
          <label htmlFor="phoneNumber" className="block text-sm font-medium text-slate-300">전화번호:</label>
          <input
            type="text"
            id="phoneNumber"
            value={phoneNumber}
            onChange={(e) => setPhoneNumber(e.target.value)}
            className="mt-1 block w-full rounded-md bg-slate-800 border-slate-600 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm text-white"
          />
        </div>
        <div>
          <label htmlFor="memberName" className="block text-sm font-medium text-slate-300">담당자 이름:</label>
          <input
            type="text"
            id="memberName"
            value={memberName}
